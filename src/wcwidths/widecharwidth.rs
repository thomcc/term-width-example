//! Port of https://github.com/ridiculousfish/widecharwidth/ to rust by hand /
//! regex. I don't recommend you use this, I just didn't want to make it link to
//! rust code.
...
#[rustfmt::skip]
const WIDECHAR_ASCII_TABLE: [(u32, u32); 1] = [
    (0x00020, 0x0007E)
];

/// Private usage range.
#[rustfmt::skip]
const WIDECHAR_PRIVATE_TABLE: [(u32, u32); 3] = [
    (0x0E000, 0x0F8FF), (0xF0000, 0xFFFFD), (0x100000, 0x10FFFD),
];

/// Nonprinting characters.
#[rustfmt::skip]
const WIDECHAR_NONPRINT_TABLE: [(u32, u32); 23] = [
...
#[rustfmt::skip]
const WIDECHAR_COMBINING_TABLE: [(u32, u32); 290] = [
...
/// Width.2 characters.
#[rustfmt::skip]
const WIDECHAR_DOUBLEWIDE_TABLE: [(u32, u32); 98] = [
...
#[rustfmt::skip]
const WIDECHAR_AMBIGUOUS_TABLE: [(u32, u32); 180] = [
    ...
    (0xE0100, 0xE01EF), (0xF0000, 0xFFFFD), (0x100000, 0x10FFF),
];

/// Unassigned characters.
#[rustfmt::skip]
const WIDECHAR_UNASSIGNED_TABLE: [(u32, u32); 688] = [
...
#[rustfmt::skip]
const WIDECHAR_WIDENED_TABLE: [(u32, u32); 27] = [
...
#[inline]
pub fn wcwidth(c: char) -> WCWidth {
    if in_table(&WIDECHAR_ASCII_TABLE, c as u32) {
        WCWidth::Width(1)
    } else if in_table(&WIDECHAR_PRIVATE_TABLE, c as u32) {
        WCWidth::PrivateUse
    } else if in_table(&WIDECHAR_NONPRINT_TABLE, c as u32) {
        WCWidth::Nonprint
    } else if in_table(&WIDECHAR_COMBINING_TABLE, c as u32) {
        WCWidth::Combining
    } else if in_table(&WIDECHAR_DOUBLEWIDE_TABLE, c as u32) {
        WCWidth::Width(2)
    } else if in_table(&WIDECHAR_AMBIGUOUS_TABLE, c as u32) {
        WCWidth::Ambiguous
    } else if in_table(&WIDECHAR_UNASSIGNED_TABLE, c as u32) {
        WCWidth::Unassigned
    } else if in_table(&WIDECHAR_WIDENED_TABLE, c as u32) {
        WCWidth::WidenedIn9
    } else {
        WCWidth::Width(1)
    }
